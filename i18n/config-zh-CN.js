...
exports.builderConfig = [
    ...
    },
    {
        ...
        script: function () {
            const baseDetils = document.querySelector('.cf-error-details');
            const ErrorMessage = baseDetils.querySelector('h1').innerText;
            const Explain = baseDetils.querySelector('p').innerText + document.querySelector('ul').innerText;
            let ErrorNumber = "5xx";
            let POP = "undefined";
            baseDetils
                .querySelector('ul.cferror_details')
                    .childNodes.forEach(e=>
                    {
                        if(e.innerText!==undefined){
                            let check = e.innerText.replace("Error reference number: ","");
    ...
    },
    {
        ...
        reason: {
            explain: "所请求网站的站长修改了 Cloudflare 安全级别或者封禁了您的 IP 地址。自从站长禁用您的 IP 后，Cloudflare support 不能覆盖他们的配置。",
            howtodo: "请联系站长并提供该页面。"
        },
        footer: [
            '来自 <a href="https://github.com/186526/CloudflareCustomErrorPage">186526/CloudflareCustomErrorPage</a> 项目',
